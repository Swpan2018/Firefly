<!-- 这是一张图片，ocr 内容为：SERVER BROWSER 1. POST /USERS/LOGIN WITH USERNAME AND PASSWORD 2. CREATES A JWT WITH A SECRET 3. RETURNS THE JWT TO THE BROWSER 4. SENDS THE JWT ON THE AUTHORIZATION HEADER 5.CHECK JWT SIGNATURE. GET USER INFORMATION 6. SENDS RESPONSE TO THE CLIENT FROM THE JWT -->
